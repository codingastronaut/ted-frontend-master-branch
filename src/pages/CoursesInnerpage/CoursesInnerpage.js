...
import CoursesInner from "../../components/CoursesInner/CoursesInner";
...
import Faqlists from "../../components/CoursesInner/Faqlist";
  ...
  useEffect(() => {
    if (id) {
      (async () => {
        ...
        console.log(respdd.data.course);
        setUniversitydetail(respdd.data.course);
      })();
    }
  }, [id]);
  return (
