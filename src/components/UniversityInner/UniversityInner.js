...
const UniversityInner = ({heading, innerheading1, innerheading2,firstlist1, firstlist2, firstlist3,firstlist4,firstlist5,secondlist1,secondlist2,secondlist3,secondlist4,secondlist5}) => {
    ...
    <>
      ...
      margin="0 auto" >
        ...
        <AccorInnerdata flexWrap="wrap" display="flex" gridGap="1rem">
          <Box 
          flex={{tabletL:"1 1 220px", mobile:"1 1 335px"}}
          >
            <Typography 
             variant={{_:"body2", tabletL: "subheader1"}} 
            color="success.highDark" mb="1rem">{innerheading1}:</Typography>
          ...
          <Typography 
             variant={{_:"body2", tabletL: "subheader1"}} 
            color="success.highDark" mb="1rem">{innerheading2}:</Typography>
             <Simplelist data={[
              secondlist1
            ]
            }/>
...
export default UniversityInner;
